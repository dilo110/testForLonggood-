...
$.fn.editInPlace.defaults = {
	...
	save_button:		'<button class="btn btn-xs btn-primary">儲存</button>', // string: image button tag to use as “Save” button
	cancel_button:		'<button class="btn btn-xs btn-primary">取消</button>', // string: image button tag to use as “Cancel” button
...
$.extend(InlineEditor.prototype, {
	...
	createEditorElement: function() {
		...
		if ("select" === this.settings.field_type)
			...
			editor = $('<input type="text" size=10'+ this.inputNameAndClass() 
